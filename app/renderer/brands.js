...
export const BRANDS = {
  dawn: {
    id: 'dawn',
    name: 'Dawn',
    sub: 'The MCPVP launcher, formerly Feather',
    glyph: glyphs.dawn,
    accent: '#FFB02B',
    accent2: '#F97316',
    install: 'drag',
    ...
    steps: [
      ...
      { title: 'Add the mod file', body: 'Press the gear on the profile, then <b>Edit</b>. Open the profile folder from there and drop the PVPTraining jar into its <b>mods</b> folder. You can drag the file straight out of this window.', jar: true },
