...
export const ICONS = {
  ...
  friends: s('<circle cx="9" cy="8.500" r="3.500"/><path d="M2.500 20c0-3.600 2.900-6 6.500-6s6.500 2.400 6.500 6"/><circle cx="17.500" cy="9.500" r="2.700"/><path d="M17 14.200c2.700 0.200 4.500 2.200 4.500 5"/>'),
  trophy: s('<path d="M7.500 4h9v5.500a4.500 4.500 0 0 1-9 0V4Z"/><path d="M7.500 6H4.500c0 3 1.200 4.500 3.300 4.800M16.500 6h3c0 3-1.200 4.500-3.300 4.800"/><path d="M12 14v3.500M8.500 20.500h7M9.500 17.500h5"/>'),
